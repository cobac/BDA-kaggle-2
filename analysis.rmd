...
- There are XX out of XX epochs that are not 128 samples long, all from the unlabeled activity
...
- We decide to remove them so that the features that are sensible to the length of the epoch are not biased
